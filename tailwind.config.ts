  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        'fall': {
          '0%': { transform: 'translateY(-20vh) translateX(-10px) rotate(0deg)', opacity: '1' },
      ...
      animation: {
        ...
        'fade-slide-out': 'fade-slide-out 0.5s ease-in forwards',
        'pop-up': 'pop-up 0.4s cubic-bezier(0.68, -0.55, 0.265, 1.55) forwards',
